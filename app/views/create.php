...
<body>
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Enter the student's information to add them to the system</p>
        </div>
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <p class="form-description">Please fill in all required fields to create a new student record.</p>
            </div>
            ...
            <form action="<?=site_url('users/create');?>" method="post" id="studentForm">
                <div class="form-row">
